...
public class JdbcUtil {
	...
	/*
	 * private static Connection physicalConnection() throws FileNotFoundException,
	 * IOException, SQLException { FileInputStream fis = new FileInputStream(
	 * "D:\\JavaServletProjects\\MVC_CRUD_APP\\src\\main\\java\\in\\ineuron\\properties\\application.proprties"
	 * ); Properties p = new Properties(); p.load(fis); String url =
	 * p.getProperty("url"); String userName = p.getProperty("userName"); String
	 * password = p.getProperty("password"); Connection connection =
