...
<br><br><br>
	<center>
	<h1 style="color: rgb(128, 0, 0); text-align:center">BOOK SEARCH FOR UPDATING</h1>
		<form action="./controller/mangEditbook" method="post">
			<section> <select name="attribute">
			  <option value="" disabled selected hidden>Choose Search options</option>
